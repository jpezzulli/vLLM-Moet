...
| Publication content base | `jpezzulli/vLLM-Moet@0544e69e63dce5a9cf597797df3db140391ba832` | mapped-host and v4 OCI publication history |
...
`jpezzulli/vllm:agent/upstream-mapped-host-w2`; its remote tip was verified at
`a2131dd7a944353e9323566107c72f4a17441024` before this documentation change.

## Runtime versus generated-patch lineage

The final DSpark-4/1M native service runs the directly pinned a2131 runtime.
The publication repository also retains
`patch/vllm-moet-v0.24.0.patch`, generated from runtime commit
`95ef4a88c63c9ed88f2384977e05d788897af6c3`. That older generated patch is
the source of the published v4 OCI image and must not be presented as the
source of the final DSpark-4/1M validation.
