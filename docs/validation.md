...
> **Historical validation:** this table covers the earlier three-mapped-layer
> DSpark-3 candidate. Final DSpark-4 quality, tools, throughput, and the
> exercised 994,987-token request are in [VALIDATION.md](../VALIDATION.md).
